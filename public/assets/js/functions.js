(function ($) {
    ...
    function rage_google_maps() {
        if ($('.rage-google-maps').length <= 0) {
            return;
        }
        $('.rage-google-maps').each(function () {
            var $this = $(this),
                $id = $this.attr('id'),
    ...
    function rage_header_sticky($elem) {
        var $this = $elem;
        $this.on('rage_header_sticky', function () {
            $this.each(function () {
        ...
        }).trigger('rage_header_sticky');
        $(window).on('resize', function () {
            $this.trigger('rage_header_sticky');
        });
    }

    function rage_vertical_menu($elem) {
        /* SHOW ALL ITEM */
        var _countLi = 0,
    ...
    function rage_auto_width_vertical_menu() {
    ...
    function rage_animation_tabs($elem, _tab_animated) {
    ...
    function rage_init_carousel($elem) {
    ...
    function rage_countdown($elem) {
        $elem.on('rage_countdown', function () {
            $elem.each(function () {
                var _this = $(this),
                    _text_countdown = '';
        ...
        }).trigger('rage_countdown');
    }

    // category product
    function rage_category_product($elem) {
        $elem.each(function () {
            var _main = $(this);
    ...
    function rage_better_equal_elems($elem) {
        $elem.each(function () {
    ...
    function rage_product_gallery($elem) {
        $elem.each(function () {
    ...
    function rage_hover_product_item($elem) {
        $elem.each(function () {
    ...
    $(window).on("load", function () {
        rage_video();
        rage_google_maps();
        if ($('.rage-threed-view').length > 0) {
            rage_threesixty();
        }
        if ($('.vertical-menu').length > 0) {
            rage_auto_width_vertical_menu();
        }
        if ($('.owl-slick').length) {
            $('.owl-slick').each(function () {
                rage_init_carousel($(this));
            });
        }
        if ($('.rage-countdown').length) {
            rage_countdown($('.rage-countdown'));
        }
        if ($('.product-gallery').length) {
            rage_product_gallery($('.product-gallery'));
        }
        if ($('.owl-slick .product-item').length) {
            rage_hover_product_item($('.rage-products .owl-slick .row-item,' +
                '.owl-slick .product-item'));
        }
        if ($('.block-nav-category').length) {
            rage_vertical_menu($('.block-nav-category'));
        }
        if ($('.widget_rage_nav_menu').length) {
            rage_vertical_menu($('.widget_rage_nav_menu'));
        }
        ...
        if ($('.widget_product_categories .product-categories').length) {
            rage_category_product($('.widget_product_categories .product-categories'));
        }
        if ($('.header-sticky .header-wrap-stick').length) {
            rage_header_sticky($('.header-sticky .header-wrap-stick'));
        }
        if ($('.equal-container.better-height').length) {
            rage_better_equal_elems($('.equal-container.better-height'));
        }
        rage_popover_button();
        rage_magnific_popup();
