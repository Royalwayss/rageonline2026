								...
								<div class="portlet-body">
									<div class="tab-content">
										<div class="tab-pane active" id="tab_1_1">
											<form role="form" id="edit_form" method="POST" action="{{ action('App\Http\Controllers\Admin\AdminController@settings') }}">
										...
										<div class="tab-pane" id="tab_1_2">
											...
											<form method="post" id="change_logo" action="{!! action('App\Http\Controllers\Admin\AdminController@changeAdminLogo') !!}" enctype="multipart/form-data" role="form">
												<input type="hidden" name="_token" value="{{ csrf_token() }}">
												<div class="form-group">
													<div class="fileinput fileinput-new" data-provides="fileinput">
														<div class="fileinput-new thumbnail" style="width:300px;">
														<?php $img=Auth::guard('admin')->user()->image;
														if($img!="")
														{?>
										...
										<div class="tab-pane" id="tab_1_3">
											<form method="POST" action="{!! action('App\Http\Controllers\Admin\AdminController@changeAdminPassword') !!}">
											<input type="hidden" name="_token" value="{{ csrf_token() }}">
												<div class="form-group">
