            ...
            <div class="col-md-12">
                <div class="portlet light">
                    <div class="portlet-title">
                        <div class="caption">
                            <span class="caption-subject font-green-sharp bold uppercase">SubAdmins</span>
                    ...
                    <div class="portlet-body">
                        <div class="table-toolbar">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="btn-group">
                                       <a href="{{action('App\Http\Controllers\Admin\AdminController@addeditSubadmin')}}" class="btn btn-primary">Add SubAdmin</a>
                                    </div>
                                </div>
                            </div>
                        </div>
