            ...
            <div class="col-md-12">
                <div class="portlet light">
                    <div class="portlet-title">
                        ...
                        <div class="actions">
                            <div class="btn-group">
                                <a href="{{url('admin/export-users')}}" class="btn btn-primary">Export Users</a>
                            </div>
                        </div>
                    </div>
                    <div class="portlet-body">
                        <div class="table-toolbar">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="btn-group">
                                       <a href="{{action('App\Http\Controllers\Admin\UsersController@addEditUser')}}" class="btn btn-primary">Add User</a>
                                    </div>
                                </div>
                            </div>
                        </div>
