            ...
            <div class="col-md-12">
                <div class="portlet light">
                    <div class="portlet-title">
                        <div class="caption">
                            <span class="caption-subject font-green-sharp bold uppercase">Notify</span>
                            ...
                            <table class="table table-striped table-bordered table-hover" id="datatable_ajax">
                                <thead>
                                    ...
                                    <tr role="row" class="filter">
                                        ...
                                        <td><input type="text" class="form-control form-filter input-sm" name="notifysize" placeholder="Size"></td>
                                        <td><input type="text" class="form-control form-filter input-sm" name="notifycode" placeholder="Product Code"></td>
