    ...
    <div class="page-content">
        <div class="page-head">
            <div class="page-title">
                <h1> Wholesale enquiry Management</h1>
            </div>
        </div>
            ...
            <div class="col-md-12">
                <div class="portlet light">
                    <div class="portlet-title">
                        <div class="caption">
                            <span class="caption-subject font-green-sharp bold uppercase"> Wholesale enquiry </span>
                            ...
                            <table class="table table-striped table-bordered table-hover" id="datatable_ajax">
                                <thead>
                                    ...
                                    <tr role="row" class="filter">
                                      ...
                                      <td><input type="text" class="form-control form-filter input-sm" name="city" placeholder="city"></td>
                                      <td><input type="text" class="form-control form-filter input-sm" name="created_at" placeholder="Created At"></td>
									  <td></td>
                                        <td>
