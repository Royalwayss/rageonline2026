            ...
            <div class="col-md-12">
                <div class="portlet light">
                    <div class="portlet-title">
                        <div class="caption">
                            <span class="caption-subject font-green-sharp bold uppercase"> Careers </span>
...
<script type="text/javascript">
    $(document).on('click','.getstatus',function(){
        ...
        var value = $(this).val();
        $.ajax({
            url : '/admn/active-deactive-review',
            data : {reviewid :reviewid,value:value},
            type : 'post',
            success:function(resp){
                $(".loadingDiv").hide();
                if(value==1){
                    alert('Review has been activated successfully!');
                }else{
                    alert('Review has been deactivated successfully!');
                }
            }
        })
    })
