...
<div class="page-content-wrapper">
    <div class="page-content">
        ...
        <ul class="page-breadcrumb breadcrumb">
            ...
            <li>
                <a href="{{ action('App\Http\Controllers\Admin\ProductsController@product_tag') }}">Products </a>
            </li>
        </ul>
            ...
            <div class="col-md-12 ">
                <div class="portlet blue-hoki box ">
                    ...
                    <div class="portlet-body form">
                        <form id="addEditProduct" role="form" class="form-horizontal" method="post" @if(!empty($producttagdata['id'])) action="{{ url('admin/add-edit-Product-tags/'.$producttagdata['id']) }}" @else action="{{ url('admin/add-edit-Product-tags') }}" @endif enctype="multipart/form-data"> 
                            <input type="hidden" name="_token" value="{{{ csrf_token() }}}"  autocomplete="off" />
                             <div class="form-body">
									<div class="form-group col-md-6">
										<label class="col-md-6 control-label">Product Tag Name:<span class="red">*</span></label>
										<div class="col-md-6">
											<input autocomplete="off" type="text" placeholder="Tag Name" name="tag_name" style="color:gray" class="form-control" value="{{(!empty($producttagdata['tag_name']))?$producttagdata['tag_name']: '' }}"/>
										</div>
									 </div>
								</div>
