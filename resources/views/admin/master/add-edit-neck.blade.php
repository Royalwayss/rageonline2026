...
<div class="page-content-wrapper">
    <div class="page-content">
        ...
        <ul class="page-breadcrumb breadcrumb">
            ...
            <li>
                <a href="{{ action('App\Http\Controllers\Admin\AdminController@neck') }}">Neck </a>
            </li>
        </ul>
            ...
            <div class="col-md-12 ">
                <div class="portlet blue-hoki box ">
                    ...
                    <div class="portlet-body form">
                        <form id="addEditProduct" role="form" class="form-horizontal" method="post" @if(!empty($neck['id'])) action="{{ url('admin/add-edit-neck/'.$neck['id']) }}" @else action="{{ url('admin/add-edit-neck') }}" @endif enctype="multipart/form-data"> 
                            <input type="hidden" name="_token" value="{{{ csrf_token() }}}"  autocomplete="off" />
                             <div class="form-body">
									<div class="form-group col-md-6">
									<br><br>
										<label class="col-md-6 control-label">Neck Name:<span class="red">*</span></label>
										<div class="col-md-6">
											<input autocomplete="off" type="text" placeholder="Neck Name" name="neck_name" style="color:gray" class="form-control" value="{{(!empty($neck['neck_name']))?$neck['neck_name']: '' }}" required/>
										</div>
									 </div>
								</div>
