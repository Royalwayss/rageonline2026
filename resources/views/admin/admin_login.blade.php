...
@section('content')
<div class="content">
	<form id="admin-login-form" class="login-form" action="{{ action('App\Http\Controllers\Admin\AdminController@login')}}" method="post">
		...
		<input type="hidden" name="stock_id" @if(isset($_GET['stock_id'])) value="{{ $_GET['stock_id'] }}" @endif>
