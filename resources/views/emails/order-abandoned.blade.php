    ...
    <body>
        ...
        <table class="main-table" border='0' cellpadding='0' cellspacing='0'  style='border:#ddd 3px dashed; padding:5px;'>
            ...
            <tr>
                ...
                <td  align='center' valign='middle' style="background-color: #253746; padding: 10px 5px; color: #fff;">Order Abandoned </td>
                            ...
                            <td>
                                 ...
                                 <table class="">
                                    ...
                                    <tr>
                                                    ...
                                                    <td style="color:red">Order Abandoned </td>
                            ...
                            <td align='left' valign='top' class='style3'>
                                ...
                                <table width='90%' border='0' align='left'>
                                    ...
                                    <tr>
										...
										This email was sent from a notification-only address that cannot accept incoming email.Please donot reply to this message</td>
