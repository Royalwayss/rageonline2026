    ...
    <body>
        ...
        <table class="main-table" border='0' cellpadding='0' cellspacing='0'  style='border:#ddd 3px dashed; padding:5px;'>
            ...
            <tr>
                ...
                <td  align='center' valign='middle' style="background-color: #253746; padding: 10px 5px; color: #fff;">Order Shipped</td>
                ...
                <td align='center' valign='top'>
                    ...
                    <table class="inner-table" width='100%'>
                        ...
                        <tr>
							...
							We thought you’d like to know that we’ve dispatched your item(s).Your order is on the way.If you would like to view the status of
                             your order,please visit <span style="color:red">Your Orders</span> on deerclubonline.com.
