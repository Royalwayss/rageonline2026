...
<main class="homeMain">
			...
			<div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
				<div class="carousel-inner">
					...
					<div class="carousel-item active">
						<a href="{{ url('shop-all') }}">
							<img src="images/banners/banner-friday-2.png?v=2.1" class="d-md-block d-none w-100" alt="winter collection"
								title="winter collection"> <!-- desktop -->
							<img src="images/banners/banner-friday-2-mobile.png?v=2.1" class="d-block d-md-none w-100"
								alt="winter collection" title="winter collection"> <!-- mobile -->
						</a>
					</div>
					*/ ?>
					...
					<div class="carousel-item">
						<a href="{{ url('winter-collection') }}">
							<img src="images/banners/autumn_winter_collection_desktop.png" class="d-md-block d-none w-100" alt="winter collection"
								title="winter collection"> <!-- desktop -->
							<img src="images/banners/autumn_winter_collection_mobile.png" class="d-block d-md-none w-100"
								alt="winter collection" title="winter collection"> <!-- mobile -->
						</a>
					</div>
					 ...
					 <div class="carousel-item">
						<a href="{{ url('winter-collection') }}">
							<img src="images/banners/18A20-off.jpg" class="d-md-block d-none w-100" alt="winter collection"
								title="winter collection"> <!-- desktop -->
							<img src="images/banners/18A20-off-mobnew.jpeg" class="d-block d-md-none w-100"
								alt="winter collection" title="winter collection"> <!-- mobile -->
						</a>
					</div>
				   ...
				   <div class="carousel-item active">
						<a href="{{ url('winter-collection') }}">
							<img src="images/banners/banner-30-off.jpeg" class="d-md-block d-none w-100" alt="winter collection"
								title="winter collection"> <!-- desktop -->
							<img src="images/banners/banner-30-off-mob.jpeg" class="d-block d-md-none w-100"
								alt="winter collection" title="winter collection"> <!-- mobile -->
						</a>
					</div>
					*/  ?>
					...
					<div class="carousel-item active">
						<a href="{{ url('winter-collection') }}">
							<img src="images/banners/50-off.jpeg" class="d-md-block d-none w-100" alt="winter collection"
								title="winter collection"> <!-- desktop -->
							<img src="images/banners/50-off-mob.jpeg" class="d-block d-md-none w-100"
								alt="winter collection" title="winter collection"> <!-- mobile -->
						</a>
					</div>
					...
					<div class="carousel-item">
						<a href="{{ url('winter-collection') }}">
							<img src="images/banners/2025.1.jpg" class="d-md-block d-none w-100" alt="winter collection"
								title="winter collection"> <!-- desktop -->
							<img src="images/banners/2025.1m.jpg" class="d-block d-md-none w-100"
								alt="winter collection" title="winter collection"> <!-- mobile -->
						</a>
					</div>
					...
					<?php /*
					 ...
					 <div class="carousel-item active">
						<a href="{{ url('winter-collection') }}">
							<img src="images/banners/18A-upto-40.jpg" class="d-md-block d-none w-100" alt="winter collection"
								title="winter collection"> <!-- desktop -->
							<img src="images/banners/18-Mobile-upto.jpg" class="d-block d-md-none w-100"
								alt="winter collection" title="winter collection"> <!-- mobile -->
						</a>
					</div>
					...
					<div class="carousel-item">
						<a href="{{ url('winter-collection') }}">
							<img src="images/banners/banner_2025_1.jpg" class="d-md-block d-none w-100" alt="winter collection"
								title="winter collection"> <!-- desktop -->
							<img src="images/banners/banner_2025_1m.jpg" class="d-block d-md-none w-100"
								alt="winter collection" title="winter collection"> <!-- mobile -->
						</a>
					</div>
				   ...
				   <div class="carousel-item">
				 	...
				 	<div class="carousel-item">
						<a href="{{ url('winter-collection') }}">
							<img src="images/banners/banner_2025_2.jpg" class="d-md-block d-none w-100" alt="winter collection"
								title="winter collection"> <!-- desktop -->
							<img src="images/banners/banner_2025_2m.jpg" class="d-block d-md-none w-100"
								alt="winter collection" title="winter collection"> <!-- mobile -->
						</a>
					</div>   */ ?>
                  ...
                  if($product['current_discount'] == 'product'){
					...
					<div class="product-slide">
						<div class="product-img">
							@if(!empty($discount_percentage)) <span class="offprice">{{ $discount_percentage }}%
								Off</span> @endif
							<a href="{{url('/product/'.$product['seo_url']) }}">
								@if(!empty($product_image))
								<img src="{{ asset('images/ProductImages/large/'.$product_image)}}?v=1.0"
									alt="{{ $product['product_name'] }}" title="{{ $product['product_name'] }}" />
								@else
								<img src="{{asset('images/no-image-found.jpg')}}" alt="{{ $product['product_name'] }}"
									title="{{ $product['product_name'] }}" width="600" height="778"
									style="height: 364px;" />
								@endif
							</a>
						</div>
						<div class="product-content">
							<a href="{{url('/product/'.$product['seo_url']) }}" class="product-title">{{
						  ...
						  @endif
							<button <?php /* data-bs-toggle="offcanvas" data-bs-target="#productOffcanvas"
								aria-controls="productOffcanvas" */ ?> data-product-seo_url="{{ $product['seo_url'] }}"
								...
								<svg xmlns="http://www.w3.org/2000/svg" version="1.1"
									...
									<g>
										<path
											d="M24 8h-2a6 6 0 0 0-12 0H8a3 3 0 0 0-3 3v14a5.006 5.006 0 0 0 5 5h12a5.006 5.006 0 0 0 5-5V11a3 3 0 0 0-3-3zm-8-4a4 4 0 0 1 4 4h-8a4 4 0 0 1 4-4zm9 21a3 3 0 0 1-3 3H10a3 3 0 0 1-3-3V11a1 1 0 0 1 1-1h2v2a1 1 0 0 0 2 0v-2h8v2a1 1 0 0 0 2 0v-2h2a1 1 0 0 1 1 1z"
											data-name="Layer 2" fill="#000000" opacity="1" data-original="#212121">
										</path>
									</g>
								</svg>
							</button>
	...
	<div class="sticky-section categories-section" data-aos="fade-up">
		<div class="row d-none d-md-flex">
			...
			<div class="categories-tabs d-none d-md-flex">
				...
				<button class="tab-btn @if($cat_key == 0) active @endif" data-tab="{{ $cat_key }}">{{
			...
			<div class="col-6  image-col">
				<div class="image-box">
					...
					@if($category['id'] == 15)
					@foreach($category['subcategories'] as $cat_key=>$sub_category)
					<img src="{{ asset('images/CategoryImages/'.$sub_category['image']) }}" alt="Image {{ $cat_key+1 }}"
						class="sticky-img @if($cat_key == 0) active @endif">
					@endforeach
					@endif
					@endforeach
				</div>
		...
		<div id="categoriesCarousel" class="carousel slide d-block d-md-none" data-bs-ride="carousel">
			...
			<div class="carousel-indicators">
				...
				@if($category['id'] == 15)
				@foreach($category['subcategories'] as $cat_key=>$sub_category)
				<button type="button" data-bs-target="#categoriesCarousel" data-bs-slide-to="{{ $cat_key }}"
					@if($cat_key==0) class="active" @endif></button>
				@endforeach
				@endif
				@endforeach
			</div>
				...
				<div class="carousel-item @if($cat_key == 0) active @endif">
					<div class="row">
						<div class="col-md-6 image-col">
							<img src="{{ asset('images/CategoryImages/'.$sub_category['image']) }}"
								class="d-block w-100" alt="{{ $sub_category['name'] }}">
						</div>
	...
	<div class="container-fluid p-0" data-aos="fade-right">
		<a href="{{ url('rage-luxe') }}"><img src="images/luxe25.jpg" class="img-fluid" alt="Premium Collection"
	...
	<div class="container-fluid celebs-video">
		<div class="row">
			...
			<div class="col-md-7 col-12 celebs-img">
...
<div class="container luxe-section store-locator" data-aos="fade-up">
		<div class="row">
			...
			<div class="col-md-12 col-12 luxe-img" data-aos="fade-left">
				<a href="{{ url('rage-luxe') }}"><img src="images/location.jpg" class="img-fluid" alt="Store Locator"
						title="Store Locator"></a>
			</div>
			<div class="col-md-12 col-12 luxe-content" data-aos="fade-left">
				<div class="store-content">
					<a href="{{ url('/store-locator') }}" class="btn-cart2">Find Your Nearest Store</a>
				</div>
			</div>
		</div>
	</div>
