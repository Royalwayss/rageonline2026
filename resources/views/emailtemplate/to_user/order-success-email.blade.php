         ...
         <tr>
            <td height='70' align='right' valign='top'>
               <table width='93%' border='0' align='right' cellpadding='3' cellspacing='0' >
                  ...
                  <tr>
                     <td align='left' valign='top' class='style3'><span class='style2'>Dear</span>  {{ $orderDetails['order_address']['billing_name'] }}
                  </tr>
                  <tr>
                     <td align='left' valign='top' class='style3'>&nbsp;</td>
                  </tr>
                  ...
                  <tr>
                     <td align='left' valign='top' class='style3'>
                        <strong>
                        @if($orderDetails['payment_method'] == 'payu') 
                        Your order has been placed with the following details:
                        @else
                        Your order has been placed with {{ $payment_method }}
                        @endif
                        </strong>
                     </td>
                  </tr>
